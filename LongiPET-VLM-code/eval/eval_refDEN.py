...
def parse_args(args=None):
    ...
    parser.add_argument("--output_dir", type=str, default='/home/project/LongiPET-VLM-model_results/eval_refDEN/')
...
def main():
    ...
    with open("/home/project/LongiPET-VLM-dataPath/DEN.json", "r", encoding="utf-8") as f:
        data = json.load(f)
