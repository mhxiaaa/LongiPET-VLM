...
# python3 /home/mx79/project_pi_cl598/mx79/LongiPET-VLM/eval/eval_reporting.py
...
def parse_args(args=None):
    ...
    parser.add_argument("--output_path", type=str, default="/home/mx79/project_pi_cl598/mx79/LongiPET-VLM-model_results/eval_report.csv",)
...
def main():
    ...
    with open("/home/mx79/project_pi_cl598/mx79/LongiPET-VLM-dataPath/REPORT.json", "r", encoding="utf-8") as f: 
        data = json.load(f)
