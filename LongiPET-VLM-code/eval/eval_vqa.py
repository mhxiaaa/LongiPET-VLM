...
# python3 /home/mx79/project_pi_cl598/mx79/LongiPET-VLM-code/eval/eval_vqa.py
...
def parse_args(args=None):
    ...
    parser.add_argument("--output_path", type=str, default="/home/mx79/project_pi_cl598/mx79/LongiPET-VLM-model_results/eval_vqa.csv",)
...
def main():
    ...
    with open("/home/mx79/project_pi_cl598/mx79/LongiPET-VLM-dataPath/VQA_DiseaseDiagnosis.json", "r", encoding="utf-8") as f: 
        data = json.load(f)
    ...
    with open("/home/mx79/project_pi_cl598/mx79/LongiPET-VLM-dataPath/VQA_HPVstatus.json", "r", encoding="utf-8") as f: 
        data = json.load(f)
    ...
    with open("/home/mx79/project_pi_cl598/mx79/LongiPET-VLM-dataPath/VQA_RFSstatus.json", "r", encoding="utf-8") as f: 
        data = json.load(f)
    ...
    with open(args.output_path, mode="w") as outfile:
        ...
        for sample in tqdm(test_dataloader):
            ...
            writer.writerow([' '.join(question[0].replace("<im_patch>" * args.proj_out_num, "").replace("<imPre_patch>" * args.proj_out_num, "").split()),
                            ...
                            correct,
                            image_path[0].replace('/home/mx79/project_pi_cl598/mx79/0dataset/','')])
